...
if (doIt) {
    ...
    /*      Author: HC-UT40277C      */
    expected_returnValue = 0x01 ;
    ACCESS_EXPECTED_VARIABLE(DcmAppl_22_rdbi, Public_Checksum_Read_RdbiErrCodeOpenSession) = 104 ;
    /*      Author: HC-UT40277C      */
    ACCESS_EXPECTED_VARIABLE(DcmAppl_22_rdbi, Public_Checksum_Read_RdbiErrCodeOpenSession) = 141 ;
    /*      Author: HC-UT40277C      */
    ACCESS_EXPECTED_VARIABLE(DcmAppl_22_rdbi, Public_Checksum_Read_RdbiErrCodeOpenSession) = 116 ;
    /*      Author: HC-UT40277C      */ 
    ACCESS_EXPECTED_VARIABLE(DcmAppl_22_rdbi, Public_Checksum_Read_RdbiErrCodeOpenSession) = 123 ; 
...
if (doIt) {
    ...
    ACCESS_EXPECTED_VARIABLE(DcmAppl_22_rdbi, Public_Checksum_Read_Success) = 104 ;
    /*      Author: HC-UT40277C      */
    ACCESS_EXPECTED_VARIABLE(DcmAppl_22_rdbi, Public_Checksum_Read_Success) = 141 ;
    /*      Author: HC-UT40277C      */
    ACCESS_EXPECTED_VARIABLE(DcmAppl_22_rdbi, Public_Checksum_Read_Success) = 116 ;
    /*      Author: HC-UT40277C      */ 
    ACCESS_EXPECTED_VARIABLE(DcmAppl_22_rdbi, Public_Checksum_Read_Success) = 123 ; 
